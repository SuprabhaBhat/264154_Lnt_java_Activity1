...
public class Inheritance_Vehicle {
	...
	public Inheritance_Vehicle(String make,String vehicleNumber,String fuelType,Integer fuelCapacity,Integer cc) {
		this.make=make;
...
class TwoWheeler extends Inheritance_Vehicle{
...
class FourWheeler extends Inheritance_Vehicle{
